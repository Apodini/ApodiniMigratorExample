...
public struct QONECTIQ_Event {
    ...
    public var location: String = (try! String.instance(from: 3))
...
public struct QONECTIQ_HomeFeed {
    ...
    public var theme: QONECTIQ_HomeFeedTheme = (try! QONECTIQ_HomeFeedTheme.instance(from: 6))
...
public struct QONECTIQ_Review {
    ...
    public var displayReviewerName: Bool = (try! Bool.instance(from: 0))
...
public struct QONECTIQ_UserRegisterForm {
    ...
    public var email: String = String()
    public var subscribedToNewsLetter: Bool = false
    public var preferredTheme: QONECTIQ_HomeFeedTheme = (try! QONECTIQ_HomeFeedTheme.instance(from: 1))
...
extension QONECTIQ_Event: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        ...
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 4: try {
                ...
                self.reviews = try [QONECTIQ_Review].from(reviews, script: 15)
            }()
            case 5: try {
            ...
            case 12: try {
                ...
                self._category = try QONECTIQ_EventCategory.from(_category, script: 17)
            }()
            default: break
            }
        }
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !reviews.isEmpty {
            try visitor.visitRepeatedMessageField(value: try [QONECTIQ_Review].from(reviews, script: 14), fieldNumber: 4)
        }
        ...
        try { if let value = _maxParticipants {
            ...
            try visitor.visitSingularUInt64Field(value: try UInt64.instance(from: 4), fieldNumber: 8)
        } }()
        ...
        try { if let value = _category {
            try visitor.visitSingularMessageField(value: try QONECTIQ_EventCategory.from(value, script: 16), fieldNumber: 12)
        } }()
...
extension QONECTIQ_Event: Codable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(try [QONECTIQ_Review].from(reviews, script: 14), forKey: .reviews)
        try container.encodeIfPresent(_date, forKey: .date)
        try container.encode(duration, forKey: .duration)
        try container.encode(imagePath, forKey: .imagePath)
        try container.encode(_maxParticipants ?? (try UInt64.instance(from: 4)), forKey: .maxParticipants)
        try container.encode(organizer, forKey: .organizer)
        try container.encode(tags, forKey: .tags)
        try container.encode(try QONECTIQ_EventCategory.from(_category, script: 16), forKey: .category)
    ...
    public init(from decoder: Swift.Decoder) throws {
        ...
        reviews = try [QONECTIQ_Review].from(try container.decode([QONECTIQ_Review].self, forKey: .reviews), script: 15)
        ...
        _category = try QONECTIQ_EventCategory.from(try container.decode(QONECTIQ_EventCategory.self, forKey: .category), script: 17)
...
extension QONECTIQ_EventCategory: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        ...
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 3: try {
                ...
                try decoder.decodeSingularEnumField(value: &group)
                self.group = try QONECTIQ_EventCategoryGroup.from(group, script: 21)
            }()
            default: break
            }
        }
        status = try QONECTIQ_CategoryStatus.instance(from: 5)
    }
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if group != .marketing {
            try visitor.visitSingularEnumField(value: try QONECTIQ_EventCategoryGroup.from(group, script: 20), fieldNumber: 3)
        }
...
extension QONECTIQ_EventCategory: Codable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(id, forKey: .id)
        try container.encode(title, forKey: .title)
        try container.encode(try QONECTIQ_EventCategoryGroup.from(group, script: 20), forKey: .group)
    ...
    public init(from decoder: Swift.Decoder) throws {
        ...
        id = try container.decode(String.self, forKey: .id)
        title = try container.decode(String.self, forKey: .title)
        group = try QONECTIQ_EventCategoryGroup.from(try container.decode(QONECTIQ_EventCategoryGroup.self, forKey: .group), script: 21)
        status = try QONECTIQ_CategoryStatus.instance(from: 5)
    }
}
...
extension QONECTIQ_EventMediator: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        try { if let value = _maxParticipants {
            ...
            try visitor.visitSingularUInt64Field(value: try UInt64.instance(from: 2), fieldNumber: 3)
        } }()
...
extension QONECTIQ_EventMediator: Codable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(_maxParticipants ?? (try UInt64.instance(from: 2)), forKey: .maxParticipants)
    }
...
extension QONECTIQ_HomeFeed: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        ...
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 6: try {
                ...
                self.events = try [QONECTIQ_HomeFeedEvent].from(events, script: 27)
            }()
            case 7: try {
                var categories: [QONECTIQ_HomeFeedCategory] = []
                try decoder.decodeRepeatedMessageField(value: &categories)
                self.categories = try [QONECTIQ_HomeFeedCategory].from(categories, script: 25)
            }()
            case 8: try {
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !events.isEmpty {
            try visitor.visitRepeatedMessageField(value: try [QONECTIQ_HomeFeedEvent].from(events, script: 26), fieldNumber: 6)
        }
        if !categories.isEmpty {
            try visitor.visitRepeatedMessageField(value: try [QONECTIQ_HomeFeedCategory].from(categories, script: 24), fieldNumber: 7)
        }
        if theme != (try! QONECTIQ_HomeFeedTheme.instance(from: 6)) {
...
extension QONECTIQ_HomeFeed: Codable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(try [QONECTIQ_HomeFeedEvent].from(events, script: 26), forKey: .events)
        try container.encode(try [QONECTIQ_HomeFeedCategory].from(categories, script: 24), forKey: .categories)
    ...
    public init(from decoder: Swift.Decoder) throws {
        ...
        events = try [QONECTIQ_HomeFeedEvent].from(try container.decode([QONECTIQ_HomeFeedEvent].self, forKey: .events), script: 27)
        categories = try [QONECTIQ_HomeFeedCategory].from(try container.decode([QONECTIQ_HomeFeedCategory].self, forKey: .categories), script: 25)
...
extension QONECTIQ_HomeFeedEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        ...
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 4: try {
                ...
                try decoder.decodeSingularStringField(value: &imageURL)
                self.imageURL = try String.from(imageURL, script: 23)
            }()
            case 5: try {
                try decoder.decodeSingularUInt64Field(value: &eventsCount)
            }()
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !imageURL.isEmpty {
            try visitor.visitSingularStringField(value: try String.from(imageURL, script: 22), fieldNumber: 4)
        }
        if eventsCount != 0 {
...
extension QONECTIQ_HomeFeedEvent: Codable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(title, forKey: .title)
        try container.encode(subtitle, forKey: .subtitle)
        try container.encode(try String.from(imageURL, script: 22), forKey: .imageURL)
        try container.encode(eventsCount, forKey: .eventsCount)
    }
    ...
    public init(from decoder: Swift.Decoder) throws {
        ...
        title = try container.decode(String.self, forKey: .title)
        subtitle = try container.decode(String.self, forKey: .subtitle)
        imageURL = try String.from(try container.decode(String.self, forKey: .imageURL), script: 23)
        eventsCount = try container.decode(UInt64.self, forKey: .eventsCount)
    }
}
...
extension QONECTIQ_Review: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        ...
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 7: try {
                ...
                self.rating = try QONECTIQ_Rating.from(rating, script: 1)
            }()
            case 8: try {
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if rating != .outstanding {
            try visitor.visitSingularEnumField(value: try QONECTIQ_Rating.from(rating, script: 0), fieldNumber: 7)
        }
        if displayReviewerName != (try! Bool.instance(from: 0)) {
...
extension QONECTIQ_Review: Codable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(summary, forKey: .summary)
        try container.encode(try QONECTIQ_Rating.from(rating, script: 0), forKey: .rating)
    ...
    public init(from decoder: Swift.Decoder) throws {
        ...
        summary = try container.decode(String.self, forKey: .summary)
        rating = try QONECTIQ_Rating.from(try container.decode(QONECTIQ_Rating.self, forKey: .rating), script: 1)
...
extension QONECTIQ_ReviewForm: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        ...
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 4: try {
                var rating: QONECTIQ_Rating = .outstanding
                try decoder.decodeSingularEnumField(value: &rating)
                self.rating = try QONECTIQ_Rating.from(rating, script: 19)
            }()
            default: break
            }
        }
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if rating != .outstanding {
            try visitor.visitSingularEnumField(value: try QONECTIQ_Rating.from(rating, script: 18), fieldNumber: 4)
        }
...
extension QONECTIQ_ReviewForm: Codable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(content, forKey: .content)
        try container.encode(summary, forKey: .summary)
        try container.encode(try QONECTIQ_Rating.from(rating, script: 18), forKey: .rating)
    }
    ...
    public init(from decoder: Swift.Decoder) throws {
        ...
        content = try container.decode(String.self, forKey: .content)
        summary = try container.decode(String.self, forKey: .summary)
        rating = try QONECTIQ_Rating.from(try container.decode(QONECTIQ_Rating.self, forKey: .rating), script: 19)
    }
}
...
extension QONECTIQ_User: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        ...
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 8: try {
                ...
                try decoder.decodeSingularEnumField(value: &experience)
                self.experience = try QONECTIQ_Experience.from(experience, script: 9)
            }()
            case 9: try {
                var reviews: [QONECTIQ_Review] = []
                try decoder.decodeRepeatedMessageField(value: &reviews)
                self.reviews = try [QONECTIQ_Review].from(reviews, script: 7)
            }()
            case 10: try {
                var ownEvents: [QONECTIQ_Event] = []
                try decoder.decodeRepeatedMessageField(value: &ownEvents)
                self.ownEvents = try [QONECTIQ_Event].from(ownEvents, script: 3)
            }()
            case 11: try {
            ...
            case 12: try {
                ...
                self.eventsOfInterest = try [QONECTIQ_Event].from(eventsOfInterest, script: 5)
            }()
            case 13: try {
                var _homeFeed: QONECTIQ_HomeFeed? = QONECTIQ_HomeFeed()
                try decoder.decodeSingularMessageField(value: &_homeFeed)
                self._homeFeed = try QONECTIQ_HomeFeed.from(_homeFeed, script: 13)
            }()
            default: break
            }
        }
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if experience != .beginner {
            try visitor.visitSingularEnumField(value: try QONECTIQ_Experience.from(experience, script: 8), fieldNumber: 8)
        }
        if !reviews.isEmpty {
            try visitor.visitRepeatedMessageField(value: try [QONECTIQ_Review].from(reviews, script: 6), fieldNumber: 9)
        }
        if !ownEvents.isEmpty {
            try visitor.visitRepeatedMessageField(value: try [QONECTIQ_Event].from(ownEvents, script: 2), fieldNumber: 10)
        }
        ...
        if !eventsOfInterest.isEmpty {
            try visitor.visitRepeatedMessageField(value: try [QONECTIQ_Event].from(eventsOfInterest, script: 4), fieldNumber: 12)
        }
        try { if let value = _homeFeed {
            try visitor.visitSingularMessageField(value: try QONECTIQ_HomeFeed.from(value, script: 12), fieldNumber: 13)
        } }()
...
extension QONECTIQ_User: Codable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(try QONECTIQ_Experience.from(experience, script: 8), forKey: .experience)
        try container.encode(try [QONECTIQ_Review].from(reviews, script: 6), forKey: .reviews)
        try container.encode(try [QONECTIQ_Event].from(ownEvents, script: 2), forKey: .ownEvents)
        try container.encode(try [QONECTIQ_Event].from(participatingEvents, script: 10), forKey: .participatingEvents)
        try container.encode(try [QONECTIQ_Event].from(eventsOfInterest, script: 4), forKey: .eventsOfInterest)
        try container.encodeIfPresent(try QONECTIQ_HomeFeed.from(_homeFeed, script: 12), forKey: .homeFeed)
    }
    ...
    public init(from decoder: Swift.Decoder) throws {
        ...
        experience = try QONECTIQ_Experience.from(try container.decode(QONECTIQ_Experience.self, forKey: .experience), script: 9)
        reviews = try [QONECTIQ_Review].from(try container.decode([QONECTIQ_Review].self, forKey: .reviews), script: 7)
        ownEvents = try [QONECTIQ_Event].from(try container.decode([QONECTIQ_Event].self, forKey: .ownEvents), script: 3)
        ...
        eventsOfInterest = try [QONECTIQ_Event].from(try container.decode([QONECTIQ_Event].self, forKey: .eventsOfInterest), script: 5)
        _homeFeed = try QONECTIQ_HomeFeed.from(try container.decodeIfPresent(QONECTIQ_HomeFeed.self, forKey: .homeFeed), script: 13)
    }
}
...
extension QONECTIQ_UserRegisterForm: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if preferredTheme != (try! QONECTIQ_HomeFeedTheme.instance(from: 1)) {
